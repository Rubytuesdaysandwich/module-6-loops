...
<br/>
<?php
reset($ages);//resets ages to the beginning allow the array pointer below to work 
...
?>
<?php
//!data base pointers moved by the database driver arrray pointers
?>
